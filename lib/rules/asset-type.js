module.exports = {
    ...
    lint: function (enable, document, reporter) {
        ...
        document.querySelectorAll('link[type="text/css"]').forEach(function (element) {
            reporter.warn(element, 'Default value of attribute "type" ("text/css") does not need to be set.');
        });

        document.querySelectorAll('script[type="text/javascript"]').forEach(function (element) {
            reporter.warn(element, 'Default value of attribute "type" ("text/javascript") does not need to be set.');
        });
    }
