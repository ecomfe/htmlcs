...
rules.html = {
    ...
    validContent: function (element) {
        ...
        // TODO: content: raw - a head element followed by a body element
        return null;
    }
};
...
rules.head = {
    ...
    validContent: function (element) {
        var children = element.children;
        // TODO: content: raw - if the document is an iframe srcdoc document or if title information is available from a higher-level protocol: zero or more elements of metadata content, of which no more than one is a title element and no more than one is a base element
        // TODO: content: raw - otherwise: one or more elements of metadata content, of which exactly one is a title element and no more than one is a base element
        return null;
    }
};
...
rules.title = {
    ...
    validContent: function (element) {
        var children = element.children;
        // TODO: content: raw - text that is not inter-element whitespace
        return null;
    }
};
...
rules.nav = {
    ...
    validContent: function (element) {
        var children = element.children;
        // TODO: content: raw - flow content, but with no main element descendants
        return null;
    }
};
...
rules.header = {
    ...
    validContent: function (element) {
        var children = element.children;
        // TODO: content: raw - flow content, but with no header, footer, or main element descendants
        return null;
    }
};
...
rules.main = {
    ...
    validContext: function (element) {
        // TODO: context: raw - where flow content is expected, but with no article, aside, footer, header or nav element ancestors
        return null;
    },
    validContent: function (element) {
        var children = element.children;
