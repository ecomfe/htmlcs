...
var nodeTypeMap = require('./node').typeMap;
...
module.exports = {
    ...
    collectInlineCfg: function (parser) {
        ...
        var collect = function (ruleName, info, target) {
            (target[ruleName] = target[ruleName] || []).push(info);
        };
    ...
    lintDocument: function (document, reporter, cfg, code) {
        ...
        util.walk(document, function (node) {
            if (node.nodeType === nodeTypeMap.COMMENT_NODE) {
