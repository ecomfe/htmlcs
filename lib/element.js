...
Element.extend = function (element) {
    ...
    util.extendAttribute(element, {
        ...
        classList: {
            get: function () {
                return this._attribs.class ? this._attribs.class.split(' ') : [];
            }
        },

        attributes: {
            get: function () {
                var attribs = this._attribs;
...
Element.prototype = util.extend(new Node(), {
    ...
    getAttribute: function (name) {
        return this.hasAttribute(name) ? this._attribs[name] : null;
    },
